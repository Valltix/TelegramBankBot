...
public class SignAfterCommaButtons {
    ...
    public static void handleSingButton(String bankCallbackData) {
        Menu bankMenu = Menu.valueOf(bankCallbackData);
        if (selectedSignsAfterComma.contains(bankMenu)) {
            selectedSignsAfterComma.remove(bankMenu);
        } else {
            selectedSignsAfterComma.add(bankMenu);
        }
    }
